(*
  #****m* SecDec/general/src/subexp/parts.m
  #  NAME
  #    parts.m
  #
  #  USAGE
...
-ipsum[ipx,ipa,ipe,0]intparts[D[ipf,ipx],{set1,set2},ipe]

intparts[ipf_,{set1___,{ipx_,ipa_,ipk_},set2___},ipe_]:=Module[{},
If[ipk<-1,(1/(ipk+1+ipa eps)
(intparts[ipf/.ipx->1,{set1,set2},ipe]-intparts[D[ipf,ipx],{set1,{ipx,ipa,ipk+1},set2},ipe])),
ipx^(ipk+ipa eps) *intparts[ipf,{set1,set2},ipe]]];
