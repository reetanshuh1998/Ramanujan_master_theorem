#ifndef pysecdec_C0_unequal_lib_hpp_included
#define pysecdec_C0_unequal_lib_hpp_included
...
namespace pysecdec_C0_unequal_lib
{
    ...
    #define pysecdec_C0_unequal_lib_contour_deformation 1
    ...
    template<template<typename...> class container_t> using handler_t = secdecutil::amplitude::WeightedIntegralHandler<integrand_return_t,real_t,integrand_return_t,container_t>;
            ...
            typedef secdecutil::CudaIntegrandContainerWithDeformation
                    <
                        ...
                        'p','y','s','e','c','d','e','c','_','C','0','_','u','n','e','q','u','a','l','_','l','i','b'
                    >
                    cuda_integrand_t;
...
{
    template <>
    struct common_type<pysecdec_C0_unequal_lib::cuda_together_integrand_t, pysecdec_C0_unequal_lib::cuda_integrand_t> 
    {
        using type = pysecdec_C0_unequal_lib::cuda_together_integrand_t;
    };
}
#endif
