...
extern "C" int
pysecdec_C0_unequal_lib_integral__sector_3_order_0(
...
extern "C" void
pysecdec_C0_unequal_lib_integral__sector_3_order_0__maxdeformp(
...
)
{
    ...
    for (; index < index2; index += 4) {
        ...
        auto tmp1_5 = SecDecInternalSqr(m3sq);
...
extern "C" int
pysecdec_C0_unequal_lib_integral__sector_3_order_0__fpolycheck(
    const uint64_t lattice,
    const uint64_t index1,
    const uint64_t index2,
    const uint64_t * restrict genvec,
