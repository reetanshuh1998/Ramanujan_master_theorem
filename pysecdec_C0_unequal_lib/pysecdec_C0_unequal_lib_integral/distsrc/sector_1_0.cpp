...
extern "C" int
pysecdec_C0_unequal_lib_integral__sector_1_order_0(
...
)
{
    ...
    for (; index < index2; index += 4) {
        ...
        auto tmp1_10 = x0*tmp1_7;
        auto tmp3_1 = x1*tmp1_2;
        auto tmp3_2 = x0 + tmp1_7;
        auto tmp3_3 = -1 + tmp1_3;
        auto tmp3_4 = SecDecInternalLambda1*tmp3_3;
        auto tmp1_11 = SecDecInternalLambda1*x1;
        auto tmp1_12 = SecDecInternalLambda0*x0;
        auto tmp3_5 = -1 + tmp1_6;
        ...
        auto tmp2_9 = __PowCall1 + tmp1_10;
        auto tmp3_7 = __PowCall5*tmp2_9;
        auto tmp2_10 = __PowCall2 + tmp3_1;
        auto tmp3_8 = __PowCall4*tmp2_10;
        auto tmp2_11 = tmp3_2*__PowCall3;
        auto tmp3_9 = tmp1_9 + tmp2_11 + tmp3_8 + tmp3_7;
        auto tmp3_10 = tmp1_8*__PowCall5;
        auto tmp3_11 = x1*__PowCall4;
        auto tmp3_12 = tmp3_11 + tmp3_10 + __PowCall3-tmp1_5;
        auto tmp3_13 = tmp1_4*__PowCall4;
        auto tmp2_12 = x0*__PowCall5;
        auto tmp3_14 = tmp2_12 + tmp3_13 + __PowCall3-tmp1_1;
        auto tmp3_15 = -s + __PowCall5 + __PowCall4;
        auto tmp2_13 = 2*__PowCall5;
        auto tmp2_14 = 2*__PowCall4;
        auto __RealPartCall1 = SecDecInternalRealPart(tmp2_13);
        auto __RealPartCall2 = SecDecInternalRealPart(tmp2_14);
        ...
        auto tmp3_39 = tmp3_30 + 1;
        auto tmp3_40 = tmp3_20*tmp3_39;
        auto tmp3_41 = __PowCall6 + tmp3_40;
        auto tmp3_42 = __PowCall5*tmp3_41;
        auto tmp3_43 = tmp3_20*tmp3_30;
        auto tmp3_44 = __PowCall7 + tmp3_30 + tmp3_43;
        auto tmp3_45 = __PowCall4*tmp3_44;
        auto tmp3_46 = tmp3_20 + tmp3_39;
        auto tmp3_47 = __PowCall3*tmp3_46;
        auto tmp3_48 = -s*tmp3_43;
        auto tmp3_49 = tmp3_48 + tmp3_47 + tmp3_45 + tmp3_42;
        auto __DenominatorCall2 = SecDecInternalDenominator(tmp3_35);
        auto __DenominatorCall1 = SecDecInternalDenominator(tmp3_49);
        auto tmp3_50 = -tmp3_9 + tmp3_49;
        auto tmp3_51 = tmp3_38*__DenominatorCall1*__DenominatorCall2;
        auto _SignCheckExpression = SecDecInternalImagPart(tmp3_50);
        SecDecInternalSignCheckContourDeformation(!(_SignCheckExpression<=0), 1);
        auto tmp3_52 = SecDecInternalRealPart(tmp3_35);
        SecDecInternalSignCheckPositivePolynomial(!(tmp3_52>=0), 1);
        acc = acc + w*(tmp3_51);
    }
...
extern "C" void
pysecdec_C0_unequal_lib_integral__sector_1_order_0__maxdeformp(
...
extern "C" int
pysecdec_C0_unequal_lib_integral__sector_1_order_0__fpolycheck(
    const uint64_t lattice,
    const uint64_t index1,
    const uint64_t index2,
    const uint64_t * restrict genvec,
...
)
{
    ...
    for (; index < index2; index += 4) {
        ...
        auto tmp1_2 = SecDecInternalSqr(m2sq);
        auto tmp1_3 = -s + tmp1_1 + tmp1_2;
        auto tmp1_4 = x0*tmp1_3;
        auto tmp1_5 = SecDecInternalSqr(m1sq);
        auto tmp1_6 = tmp1_5 + tmp1_2;
        auto tmp1_7 = x1*tmp1_2;
        auto tmp3_1 = 2*tmp1_7 + tmp1_6 + tmp1_4;
        auto tmp3_2 = x1*tmp1_3;
        auto tmp1_8 = tmp1_5 + tmp1_1;
        auto tmp1_9 = x0*tmp1_1;
        ...
        auto fpoly_im = SecDecInternalImagPart(tmp1_5 + __Deformedx1Call*tmp1_6 + SecDecInternalSqr(__Deformedx1Call)*tmp1_2 + __Deformedx0Call*tmp1_8 + __Deformedx0Call*__Deformedx1Call*tmp1_3 + SecDecInternalSqr(__Deformedx0Call)*tmp1_1);
