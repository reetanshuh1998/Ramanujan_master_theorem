#ifndef pysecdec_C0_unequal_lib_integral_hpp_included
#define pysecdec_C0_unequal_lib_integral_hpp_included
...
namespace pysecdec_C0_unequal_lib_integral
{
    ...
    #define pysecdec_C0_unequal_lib_integral_has_complex_parameters 0

    // whether or not the return type should be complex in any case
    #define pysecdec_C0_unequal_lib_integral_enforce_complex_return_type 0
    ...
    #endif
    #if pysecdec_C0_unequal_lib_integral_has_complex_parameters || pysecdec_C0_unequal_lib_integral_contour_deformation || pysecdec_C0_unequal_lib_integral_enforce_complex_return_type
    ...
    const std::string package_name = "pysecdec_C0_unequal_lib_integral";
    ...
    const std::vector<std::string> names_of_real_parameters = {"s","m1sq","m2sq","m3sq"};
    ...
    //#undef pysecdec_C0_unequal_lib_integral_has_complex_parameters
    //#undef pysecdec_C0_unequal_lib_integral_enforce_complex_return_type
...
{
    template <>
    struct common_type<pysecdec_C0_unequal_lib_integral::cuda_together_integrand_t, pysecdec_C0_unequal_lib_integral::cuda_integrand_t> 
    {
        using type = pysecdec_C0_unequal_lib_integral::cuda_together_integrand_t;
    };
}
#endif
