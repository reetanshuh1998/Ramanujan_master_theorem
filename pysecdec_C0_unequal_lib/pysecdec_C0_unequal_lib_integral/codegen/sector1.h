...
#procedure insertDecomposed
    Id F(x0?,x1?,eps?) =  + ( + (m3sq^2))*x0^2 + ( + (m2sq^2 + m3sq^2 - s))*x0*x1 + ( + (m2sq^2))*x1^2 + ( + (m1sq^2 + m3sq^2))*x0 + ( + (m1sq^2 + m2sq^2))*x1 + ( + (m1sq^2));
  Id U(x0?,x1?,eps?) =  + ( + (1)) + ( + (1))*x1 + ( + (1))*x0;
  Id dFd0(x0?,x1?,eps?) =  + (m1sq^2 + m3sq^2) + (m2sq^2 + m3sq^2 - s)*x1 + (2*m3sq^2)*x0;
  Id dFd1(x0?,x1?,eps?) =  + (m1sq^2 + m2sq^2) + (2*m2sq^2)*x1 + (m2sq^2 + m3sq^2 - s)*x0;
  Id ddFd0d0(x0?,x1?,eps?) =  + (2*m3sq^2);
  Id ddFd0d1(x0?,x1?,eps?) =  + (m2sq^2 + m3sq^2 - s);
  Id ddFd1d1(x0?,x1?,eps?) =  + (2*m2sq^2);
