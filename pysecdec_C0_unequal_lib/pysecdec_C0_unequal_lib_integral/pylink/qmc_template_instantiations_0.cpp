...
#define INTEGRAL_NAME pysecdec_C0_unequal_lib_integral
#define pysecdec_C0_unequal_lib_integral_number_of_sectors 3
    ...
    #define INSTANTIATE_KOROBOV_QMC_SEPARATE(KOROBOVDEGREE1,KOROBOVDEGREE2) \
        ...
        template class secdecutil::integrators::Qmc< \
                                                        ...
                                                        ::integrators::fitfunctions::PolySingular::type \
                                                   >;
#if pysecdec_C0_unequal_lib_integral_number_of_sectors != 1
...
#undef pysecdec_C0_unequal_lib_integral_number_of_sectors
