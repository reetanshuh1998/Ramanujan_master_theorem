...
)
{
    ...
    return(tmp1_5 + __Deformedx1Call*tmp1_6 + SecDecInternalSqr(__Deformedx1Call)*tmp1_2 + __Deformedx0Call*tmp1_8 + __Deformedx0Call*__Deformedx1Call*tmp1_3 + SecDecInternalSqr(__Deformedx0Call)*tmp1_1);
}
}
