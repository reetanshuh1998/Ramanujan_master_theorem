...
{
return {0,1,{{2,{0},1,sector_2_order_0_integrand,
#ifdef SECDEC_WITH_CUDA
get_device_sector_2_order_0_integrand,
#endif
sector_2_order_0_contour_deformation_polynomial,sector_2_order_0_maximal_allowed_deformation_parameters},{2,{1},1,sector_2_order_1_integrand,
#ifdef SECDEC_WITH_CUDA
