#ifndef B0_standard_pysecdec_integral_hpp_included
#define B0_standard_pysecdec_integral_hpp_included
...
namespace B0_standard_pysecdec_integral
{
    ...
    #define B0_standard_pysecdec_integral_has_complex_parameters 0

    // whether or not the return type should be complex in any case
    #define B0_standard_pysecdec_integral_enforce_complex_return_type 0
    ...
    #endif
    #if B0_standard_pysecdec_integral_has_complex_parameters || B0_standard_pysecdec_integral_contour_deformation || B0_standard_pysecdec_integral_enforce_complex_return_type
    ...
    const std::string package_name = "B0_standard_pysecdec_integral";
    ...
    const std::vector<std::string> names_of_real_parameters = {"psq","msq"};
    ...
    //#undef B0_standard_pysecdec_integral_has_complex_parameters
    //#undef B0_standard_pysecdec_integral_enforce_complex_return_type
...
{
    template <>
    struct common_type<B0_standard_pysecdec_integral::cuda_together_integrand_t, B0_standard_pysecdec_integral::cuda_integrand_t> 
    {
        using type = B0_standard_pysecdec_integral::cuda_together_integrand_t;
    };
}
#endif
