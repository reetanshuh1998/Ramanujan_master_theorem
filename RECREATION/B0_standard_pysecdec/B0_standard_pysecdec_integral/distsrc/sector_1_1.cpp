...
extern "C" int
B0_standard_pysecdec_integral__sector_1_order_1(
...
)
{
    ...
    for (; index < index2; index += 4) {
        ...
        auto tmp3_5 = msq*__PowCall2;
        auto tmp3_6 = tmp3_3 + tmp3_5;
        auto _logCall2 = SecDecInternalLog(__DenominatorCall2);
        auto __PowCall1 = SecDecInternalSqr(__DenominatorCall2);
        ...
        auto __PowCall3 = SecDecInternalSqr(tmp3_8);
        auto tmp3_13 = 1 + __PowCall3;
        auto tmp3_14 = msq*tmp3_13;
        auto tmp3_15 = tmp3_8*tmp1_3;
        auto tmp3_16 = tmp3_15 + tmp3_14;
        auto _logCall4 = SecDecInternalLog(tmp3_12);
        auto __PowCall4 = SecDecInternalSqr(tmp3_12);
        auto _logCall3 = SecDecInternalLog(tmp3_16);
        auto __DenominatorCall1 = SecDecInternalDenominator(__PowCall4);
        auto tmp3_17 = -tmp3_6 + tmp3_16;
        auto tmp3_18 = _logCall2 + _logCall4;
        auto tmp3_19 = -_logCall1-_logCall3 + 2*tmp3_18;
        auto tmp3_20 = tmp3_19*tmp3_11*__DenominatorCall1;
        ...
        auto tmp3_21 = SecDecInternalRealPart(tmp3_12);
        SecDecInternalSignCheckPositivePolynomial(!(tmp3_21>=0), 1);
        acc = acc + w*(tmp3_20);
    }
...
extern "C" void
B0_standard_pysecdec_integral__sector_1_order_1__maxdeformp(
...
extern "C" int
B0_standard_pysecdec_integral__sector_1_order_1__fpolycheck(
    const uint64_t lattice,
    const uint64_t index1,
    const uint64_t index2,
    const uint64_t * restrict genvec,
