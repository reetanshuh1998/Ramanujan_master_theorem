...
#define INTEGRAL_NAME B0_standard_pysecdec_integral
#define B0_standard_pysecdec_integral_number_of_sectors 2
...
// delegate some template instantiations to separate translation units
    ...
    #define EXTERN_SIDI_QMC_SEPARATE(SIDIDEGREE) \
        ...
        extern template class secdecutil::integrators::Qmc< \
                                                               ...
                                                               ::integrators::fitfunctions::PolySingular::type \
                                                          >;
    #if B0_standard_pysecdec_integral_number_of_sectors != 1
...
#undef B0_standard_pysecdec_integral_number_of_sectors
