#ifndef B0_standard_pysecdec_hpp_included
#define B0_standard_pysecdec_hpp_included
...
namespace B0_standard_pysecdec
{
    ...
    #define B0_standard_pysecdec_contour_deformation 1
    ...
    template<template<typename...> class container_t> using handler_t = secdecutil::amplitude::WeightedIntegralHandler<integrand_return_t,real_t,integrand_return_t,container_t>;
            ...
            typedef secdecutil::CudaIntegrandContainerWithDeformation
                    <
                        ...
                        'B','0','_','s','t','a','n','d','a','r','d','_','p','y','s','e','c','d','e','c'
                    >
                    cuda_integrand_t;
...
{
    template <>
    struct common_type<B0_standard_pysecdec::cuda_together_integrand_t, B0_standard_pysecdec::cuda_integrand_t> 
    {
        using type = B0_standard_pysecdec::cuda_together_integrand_t;
    };
}
#endif
