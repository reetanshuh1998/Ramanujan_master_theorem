#ifndef bubble1L_pysecdec_hpp_included
#define bubble1L_pysecdec_hpp_included
...
namespace bubble1L_pysecdec
{
    ...
    #define bubble1L_pysecdec_contour_deformation 1
    ...
    template<template<typename...> class container_t> using handler_t = secdecutil::amplitude::WeightedIntegralHandler<integrand_return_t,real_t,integrand_return_t,container_t>;
            ...
            typedef secdecutil::CudaIntegrandContainerWithDeformation
                    <
                        ...
                        'b','u','b','b','l','e','1','L','_','p','y','s','e','c','d','e','c'
                    >
                    cuda_integrand_t;
...
{
    template <>
    struct common_type<bubble1L_pysecdec::cuda_together_integrand_t, bubble1L_pysecdec::cuda_integrand_t> 
    {
        using type = bubble1L_pysecdec::cuda_together_integrand_t;
    };
}
#endif
