...
#define INTEGRAL_NAME bubble1L_pysecdec_integral
#define bubble1L_pysecdec_integral_number_of_sectors 2
    ...
    #define INSTANTIATE_KOROBOV_QMC_SEPARATE(KOROBOVDEGREE1,KOROBOVDEGREE2) \
        ...
        template class secdecutil::integrators::Qmc< \
                                                        ...
                                                        ::integrators::fitfunctions::PolySingular::type \
                                                   >;
#if bubble1L_pysecdec_integral_number_of_sectors != 1
...
#undef bubble1L_pysecdec_integral_number_of_sectors
