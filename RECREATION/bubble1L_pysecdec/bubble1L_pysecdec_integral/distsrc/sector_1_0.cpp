...
extern "C" int
bubble1L_pysecdec_integral__sector_1_order_0(
...
)
{
    ...
    for (; index < index2; index += 4) {
        ...
        x0 = korobov3x3_f(x0);
        auto tmp1_1 = 2*m2sq;
        auto tmp1_2 = -s + m2sq + m1sq;
        auto tmp1_3 = 2*x0;
        auto tmp3_1 = m2sq*tmp1_3;
        auto tmp3_2 = tmp3_1 + tmp1_2;
        auto tmp1_4 = x0*tmp1_2;
        auto tmp3_3 = m1sq + tmp1_4;
        ...
        auto tmp3_4 = m2sq*__PowCall3;
        auto tmp3_5 = tmp3_3 + tmp3_4;
        auto __PowCall5 = SecDecInternalSqr(__DenominatorCall1);
        auto __RealPartCall2 = SecDecInternalRealPart(tmp3_2);
        auto tmp2_3 = SecDecInternalLambda0*__PowCall3;
        ...
        auto __PowCall2 = SecDecInternalPow(__PowCall5, -SecDecInternalQuo(1, 2));
        auto tmp3_11 = 1 + tmp3_7;
        auto __PowCall4 = SecDecInternalSqr(tmp3_7);
        auto tmp3_12 = tmp3_7*tmp1_2;
        auto tmp3_13 = m2sq*__PowCall4;
        auto tmp3_14 = m1sq + tmp3_12 + tmp3_13;
        auto __DenominatorCall2 = SecDecInternalDenominator(tmp3_11);
        auto __PowCall1 = SecDecInternalPow(tmp3_14, -SecDecInternalQuo(1, 2));
        auto tmp3_15 = -tmp3_5 + tmp3_14;
        auto tmp3_16 = tmp3_10*__PowCall1*__PowCall2*__DenominatorCall1*__DenominatorCall2;
...
extern "C" void
bubble1L_pysecdec_integral__sector_1_order_0__maxdeformp(
...
)
{
    ...
    for (; index < index2; index += 4) {
        ...
        auto tmp3_4 = tmp3_3 + m2sq + tmp1_2;
...
extern "C" int
bubble1L_pysecdec_integral__sector_1_order_0__fpolycheck(
    const uint64_t lattice,
    const uint64_t index1,
    const uint64_t index2,
    const uint64_t * restrict genvec,
...
)
{
    ...
    for (; index < index2; index += 4) {
        ...
        auto fpoly_im = SecDecInternalImagPart(__Deformedx0Call*tmp3_3 + m2sq*SecDecInternalSqr(__Deformedx0Call)+m1sq);
