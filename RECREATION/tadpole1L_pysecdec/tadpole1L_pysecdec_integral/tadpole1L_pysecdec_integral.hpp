#ifndef tadpole1L_pysecdec_integral_hpp_included
#define tadpole1L_pysecdec_integral_hpp_included
...
namespace tadpole1L_pysecdec_integral
{
    ...
    #define tadpole1L_pysecdec_integral_contour_deformation 1

    // whether or not complex parameters are present
    #define tadpole1L_pysecdec_integral_has_complex_parameters 0

    // whether or not the return type should be complex in any case
    #define tadpole1L_pysecdec_integral_enforce_complex_return_type 0
    ...
    #endif
    #if tadpole1L_pysecdec_integral_has_complex_parameters || tadpole1L_pysecdec_integral_contour_deformation || tadpole1L_pysecdec_integral_enforce_complex_return_type
    ...
    const std::string package_name = "tadpole1L_pysecdec_integral";
    ...
    const std::vector<std::string> names_of_real_parameters = {"msq"};
        ...
        const std::vector<complex_t>& complex_parameters
            ...
            typedef secdecutil::CudaIntegrandContainerWithDeformation
                    <
                        ...
                        't','a','d','p','o','l','e','1','L','_','p','y','s','e','c','d','e','c','_','i','n','t','e','g','r','a','l'
                    >
                    cuda_integrand_t;
            typedef secdecutil::CudaIntegrandContainerWithDeformation
                    <
    ...
    //#undef tadpole1L_pysecdec_integral_contour_deformation
    //#undef tadpole1L_pysecdec_integral_has_complex_parameters
    //#undef tadpole1L_pysecdec_integral_enforce_complex_return_type
...
{
    template <>
    struct common_type<tadpole1L_pysecdec_integral::cuda_together_integrand_t, tadpole1L_pysecdec_integral::cuda_integrand_t> 
    {
        using type = tadpole1L_pysecdec_integral::cuda_together_integrand_t;
    };
}
#endif
