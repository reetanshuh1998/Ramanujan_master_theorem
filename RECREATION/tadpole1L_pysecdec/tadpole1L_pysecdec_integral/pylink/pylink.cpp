...
#define INTEGRAL_NAME tadpole1L_pysecdec_integral
#define tadpole1L_pysecdec_integral_number_of_sectors 1
...
// delegate some template instantiations to separate translation units
    ...
    #define EXTERN_SIDI_QMC_SEPARATE(SIDIDEGREE) \
        ...
        extern template class secdecutil::integrators::Qmc< \
                                                               ...
                                                               ::integrators::fitfunctions::PolySingular::type \
                                                          >;
    #if tadpole1L_pysecdec_integral_number_of_sectors != 1
...
#undef tadpole1L_pysecdec_integral_number_of_sectors
