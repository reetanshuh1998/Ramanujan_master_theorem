...
extern "C" int
tadpole1L_pysecdec_integral__sector_1_order_0(
...
extern "C" void
tadpole1L_pysecdec_integral__sector_1_order_0__maxdeformp(
...
extern "C" int
tadpole1L_pysecdec_integral__sector_1_order_0__fpolycheck(
    const uint64_t lattice,
    const uint64_t index1,
    const uint64_t index2,
    const uint64_t * restrict genvec,
