#ifndef tadpole1L_pysecdec_hpp_included
#define tadpole1L_pysecdec_hpp_included
...
namespace tadpole1L_pysecdec
{
    ...
    #define tadpole1L_pysecdec_contour_deformation 1
    ...
    template<template<typename...> class container_t> using handler_t = secdecutil::amplitude::WeightedIntegralHandler<integrand_return_t,real_t,integrand_return_t,container_t>;
            ...
            typedef secdecutil::CudaIntegrandContainerWithDeformation
                    <
                        ...
                        't','a','d','p','o','l','e','1','L','_','p','y','s','e','c','d','e','c'
                    >
                    cuda_integrand_t;
...
{
    template <>
    struct common_type<tadpole1L_pysecdec::cuda_together_integrand_t, tadpole1L_pysecdec::cuda_integrand_t> 
    {
        using type = tadpole1L_pysecdec::cuda_together_integrand_t;
    };
}
#endif
