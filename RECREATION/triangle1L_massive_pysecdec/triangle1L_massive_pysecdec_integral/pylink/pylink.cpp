...
#define INTEGRAL_NAME triangle1L_massive_pysecdec_integral
#define triangle1L_massive_pysecdec_integral_number_of_sectors 3
...
// delegate some template instantiations to separate translation units
    ...
    #define EXTERN_SIDI_QMC_SEPARATE(SIDIDEGREE) \
        ...
        extern template class secdecutil::integrators::Qmc< \
                                                               ...
                                                               ::integrators::fitfunctions::PolySingular::type \
                                                          >;
    #if triangle1L_massive_pysecdec_integral_number_of_sectors != 1
...
#undef triangle1L_massive_pysecdec_integral_number_of_sectors
