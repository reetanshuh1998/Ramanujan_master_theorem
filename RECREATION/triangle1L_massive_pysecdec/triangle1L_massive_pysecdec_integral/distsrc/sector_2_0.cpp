...
extern "C" int
triangle1L_massive_pysecdec_integral__sector_2_order_0(
...
extern "C" void
triangle1L_massive_pysecdec_integral__sector_2_order_0__maxdeformp(
...
extern "C" int
triangle1L_massive_pysecdec_integral__sector_2_order_0__fpolycheck(
    const uint64_t lattice,
    const uint64_t index1,
    const uint64_t index2,
    const uint64_t * restrict genvec,
