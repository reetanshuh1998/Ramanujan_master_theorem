...
#procedure insertDecomposed
  ...
  Id ddFd0d1(x0?,x1?,eps?) =  + (2*msq);
  Id dFd0(x0?,x1?,eps?) =  + (2*msq - s) + (2*msq)*x1 + (2*msq)*x0;
  Id F(x0?,x1?,eps?) =  + ( + (msq)) + ( + (2*msq - s))*x0 + ( + (msq))*x0^2 + ( + (2*msq))*x1 + ( + (2*msq))*x0*x1 + ( + (msq))*x1^2;
  Id ddFd1d1(x0?,x1?,eps?) =  + (2*msq);
  Id dFd1(x0?,x1?,eps?) =  + (2*msq) + (2*msq)*x1 + (2*msq)*x0;
