#ifndef triangle1L_massive_pysecdec_integral_hpp_included
#define triangle1L_massive_pysecdec_integral_hpp_included
...
namespace triangle1L_massive_pysecdec_integral
{
    ...
    #define triangle1L_massive_pysecdec_integral_contour_deformation 1

    // whether or not complex parameters are present
    #define triangle1L_massive_pysecdec_integral_has_complex_parameters 0

    // whether or not the return type should be complex in any case
    #define triangle1L_massive_pysecdec_integral_enforce_complex_return_type 0
    ...
    #endif
    #if triangle1L_massive_pysecdec_integral_has_complex_parameters || triangle1L_massive_pysecdec_integral_contour_deformation || triangle1L_massive_pysecdec_integral_enforce_complex_return_type
    ...
    const std::string package_name = "triangle1L_massive_pysecdec_integral";
        ...
        const std::vector<complex_t>& complex_parameters
            ...
            typedef secdecutil::CudaIntegrandContainerWithDeformation
                    <
                        ...
                        't','r','i','a','n','g','l','e','1','L','_','m','a','s','s','i','v','e','_','p','y','s','e','c','d','e','c','_','i','n','t','e','g','r','a','l'
                    >
                    cuda_integrand_t;
            typedef secdecutil::CudaIntegrandContainerWithDeformation
                    <
    ...
    //#undef triangle1L_massive_pysecdec_integral_contour_deformation
    //#undef triangle1L_massive_pysecdec_integral_has_complex_parameters
    //#undef triangle1L_massive_pysecdec_integral_enforce_complex_return_type
...
{
    template <>
    struct common_type<triangle1L_massive_pysecdec_integral::cuda_together_integrand_t, triangle1L_massive_pysecdec_integral::cuda_integrand_t> 
    {
        using type = triangle1L_massive_pysecdec_integral::cuda_together_integrand_t;
    };
}
#endif
