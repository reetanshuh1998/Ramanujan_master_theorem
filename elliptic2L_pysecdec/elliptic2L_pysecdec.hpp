#ifndef elliptic2L_pysecdec_hpp_included
#define elliptic2L_pysecdec_hpp_included
...
namespace elliptic2L_pysecdec
{
    ...
    #define elliptic2L_pysecdec_contour_deformation 1
    ...
    template<template<typename...> class container_t> using handler_t = secdecutil::amplitude::WeightedIntegralHandler<integrand_return_t,real_t,integrand_return_t,container_t>;
            ...
            typedef secdecutil::CudaIntegrandContainerWithDeformation
                    <
                        ...
                        'e','l','l','i','p','t','i','c','2','L','_','p','y','s','e','c','d','e','c'
                    >
                    cuda_integrand_t;
...
{
    template <>
    struct common_type<elliptic2L_pysecdec::cuda_together_integrand_t, elliptic2L_pysecdec::cuda_integrand_t> 
    {
        using type = elliptic2L_pysecdec::cuda_together_integrand_t;
    };
}
#endif
