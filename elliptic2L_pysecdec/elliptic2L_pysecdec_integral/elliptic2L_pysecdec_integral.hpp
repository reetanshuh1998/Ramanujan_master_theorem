#ifndef elliptic2L_pysecdec_integral_hpp_included
#define elliptic2L_pysecdec_integral_hpp_included
...
namespace elliptic2L_pysecdec_integral
{
    ...
    #define elliptic2L_pysecdec_integral_contour_deformation 1

    // whether or not complex parameters are present
    #define elliptic2L_pysecdec_integral_has_complex_parameters 1

    // whether or not the return type should be complex in any case
    #define elliptic2L_pysecdec_integral_enforce_complex_return_type 0
    ...
    #endif
    #if elliptic2L_pysecdec_integral_has_complex_parameters || elliptic2L_pysecdec_integral_contour_deformation || elliptic2L_pysecdec_integral_enforce_complex_return_type
    ...
    const std::string package_name = "elliptic2L_pysecdec_integral";

    const unsigned long long number_of_sectors = 16;
        ...
        const std::vector<complex_t>& complex_parameters
            ...
            typedef secdecutil::CudaIntegrandContainerWithDeformation
                    <
                        ...
                        'e','l','l','i','p','t','i','c','2','L','_','p','y','s','e','c','d','e','c','_','i','n','t','e','g','r','a','l'
                    >
                    cuda_integrand_t;
            typedef secdecutil::CudaIntegrandContainerWithDeformation
                    <
    ...
    //#undef elliptic2L_pysecdec_integral_contour_deformation
    //#undef elliptic2L_pysecdec_integral_has_complex_parameters
    //#undef elliptic2L_pysecdec_integral_enforce_complex_return_type
...
{
    template <>
    struct common_type<elliptic2L_pysecdec_integral::cuda_together_integrand_t, elliptic2L_pysecdec_integral::cuda_integrand_t> 
    {
        using type = elliptic2L_pysecdec_integral::cuda_together_integrand_t;
    };
}
#endif
