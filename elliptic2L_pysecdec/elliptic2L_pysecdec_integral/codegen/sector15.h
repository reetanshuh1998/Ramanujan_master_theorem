...
#procedure defineExpansion
  Global expansion = SecDecInternalsDUMMYIntegrand;
    Id SecDecInternalsDUMMYIntegrand = (( + (( + (1)) * (( + (1))^(-1)))) * ( + (((( + (1)*x3^2)^( + (1))) * (( + ( + (1))*x3)^( + (0) + (-1))) * (( + ( + (1))*x3)^( + (0) + (-1))) * (( + (1))^( + (1)))) * (SecDecInternalCalI( + (1)*x0, + (1)*x1, + (1)*x2, + (1)*x3, + (0))))));
...
#procedure insertDecomposed
  ...
  Id F(x0?,x1?,x2?,x3?,eps?) =  + ( + (msq))*x1 + ( + (2*msq - s))*x0*x1 + ( + (msq))*x0^2*x1 + ( + (msq))*x1^2*x3 + ( + (msq))*x0*x1^2*x3 + ( + (msq)) + ( + (2*msq - s))*x0 + ( + (msq))*x0^2 + ( + (2*msq - s))*x1*x3 + ( + (2*msq - s))*x0*x1*x3 + ( + (msq))*x3 + ( + (msq))*x0*x3 + ( + (msq))*x2 + ( + (2*msq - s))*x0*x2 + ( + (msq))*x0^2*x2 + ( + (3*msq - s))*x1*x2*x3 + ( + (3*msq))*x0*x1*x2*x3 + ( + (msq))*x1^2*x2*x3^2 + ( + (3*msq))*x2*x3 + ( + (3*msq - s))*x0*x2*x3 + ( + (2*msq - s))*x1*x2*x3^2 + ( + (msq))*x2*x3^2 + ( + (msq))*x2^2*x3 + ( + (msq))*x0*x2^2*x3 + ( + (msq))*x1*x2^2*x3^2 + ( + (msq))*x2^2*x3^2;
  ...
  Id U(x0?,x1?,x2?,x3?,eps?) =  + ( + (1))*x2*x3 + ( + (1))*x1*x2*x3 + ( + (1))*x0*x2 + ( + (1))*x2 + ( + (1))*x0 + ( + (1)) + ( + (1))*x0*x1 + ( + (1))*x1;
