...
#procedure insertDecomposed
    Id ddFd2d2(x0?,x1?,x2?,x3?,eps?) =  + (2*msq)*x1 + (2*msq)*x1^2 + (2*msq)*x0*x1^2;
  Id ddFd0d2(x0?,x1?,x2?,x3?,eps?) =  + (3*msq - s)*x1 + (2*msq - s)*x1^2 + (2*msq - s)*x1^2*x3 + (2*msq)*x1^2*x2 + (2*msq)*x0*x1^2;
  Id ddFd0d1(x0?,x1?,x2?,x3?,eps?) =  + (2*msq - s) + (3*msq)*x3 + (3*msq - s)*x2 + (4*msq - 2*s)*x1*x3 + (2*msq)*x1*x3^2 + (4*msq - 2*s)*x1*x2 + (4*msq - 2*s)*x1*x2*x3 + (2*msq)*x1*x2^2 + (2*msq)*x0 + (4*msq)*x0*x1*x3 + (4*msq)*x0*x1*x2;
  Id ddFd1d2(x0?,x1?,x2?,x3?,eps?) =  + (3*msq) + (2*msq - s)*x3 + (2*msq)*x2 + (2*msq)*x1 + (4*msq - 2*s)*x1*x3 + (4*msq)*x1*x2 + (3*msq - s)*x0 + (4*msq - 2*s)*x0*x1 + (4*msq - 2*s)*x0*x1*x3 + (4*msq)*x0*x1*x2 + (2*msq)*x0^2*x1;
  Id F(x0?,x1?,x2?,x3?,eps?) =  + ( + (msq))*x0^2*x1^2*x2 + ( + (2*msq - s))*x0*x1^2*x2 + ( + (msq))*x1^2*x2 + ( + (msq))*x0*x1^2*x2^2 + ( + (msq))*x1^2*x2^2 + ( + (msq))*x0^2*x1^2*x3 + ( + (2*msq - s))*x0*x1^2*x3 + ( + (msq))*x1^2*x3 + ( + (2*msq - s))*x0*x1^2*x2*x3 + ( + (2*msq - s))*x1^2*x2*x3 + ( + (msq))*x0*x1^2*x3^2 + ( + (msq))*x1^2*x3^2 + ( + (msq))*x0^2*x1 + ( + (2*msq - s))*x0*x1 + ( + (msq))*x1 + ( + (3*msq - s))*x0*x1*x2 + ( + (3*msq))*x1*x2 + ( + (msq))*x1*x2^2 + ( + (3*msq))*x0*x1*x3 + ( + (3*msq - s))*x1*x3 + ( + (2*msq - s))*x1*x2*x3 + ( + (msq))*x1*x3^2 + ( + (msq))*x0 + ( + (msq)) + ( + (msq))*x2 + ( + (msq))*x3;
  Id ddFd0d0(x0?,x1?,x2?,x3?,eps?) =  + (2*msq)*x1 + (2*msq)*x1^2*x3 + (2*msq)*x1^2*x2;
  Id ddFd3d3(x0?,x1?,x2?,x3?,eps?) =  + (2*msq)*x1 + (2*msq)*x1^2 + (2*msq)*x0*x1^2;
  Id ddFd0d3(x0?,x1?,x2?,x3?,eps?) =  + (3*msq)*x1 + (2*msq - s)*x1^2 + (2*msq)*x1^2*x3 + (2*msq - s)*x1^2*x2 + (2*msq)*x0*x1^2;
  Id ddFd1d1(x0?,x1?,x2?,x3?,eps?) =  + (2*msq)*x3 + (2*msq)*x3^2 + (2*msq)*x2 + (4*msq - 2*s)*x2*x3 + (2*msq)*x2^2 + (4*msq - 2*s)*x0*x3 + (2*msq)*x0*x3^2 + (4*msq - 2*s)*x0*x2 + (4*msq - 2*s)*x0*x2*x3 + (2*msq)*x0*x2^2 + (2*msq)*x0^2*x3 + (2*msq)*x0^2*x2;
  Id dFd3(x0?,x1?,x2?,x3?,eps?) =  + (msq) + (3*msq - s)*x1 + (2*msq)*x1*x3 + (2*msq - s)*x1*x2 + (msq)*x1^2 + (2*msq)*x1^2*x3 + (2*msq - s)*x1^2*x2 + (3*msq)*x0*x1 + (2*msq - s)*x0*x1^2 + (2*msq)*x0*x1^2*x3 + (2*msq - s)*x0*x1^2*x2 + (msq)*x0^2*x1^2;
  Id ddFd1d3(x0?,x1?,x2?,x3?,eps?) =  + (3*msq - s) + (2*msq)*x3 + (2*msq - s)*x2 + (2*msq)*x1 + (4*msq)*x1*x3 + (4*msq - 2*s)*x1*x2 + (3*msq)*x0 + (4*msq - 2*s)*x0*x1 + (4*msq)*x0*x1*x3 + (4*msq - 2*s)*x0*x1*x2 + (2*msq)*x0^2*x1;
  Id U(x0?,x1?,x2?,x3?,eps?) =  + ( + (1))*x3 + ( + (1))*x2 + ( + (1)) + ( + (1))*x0 + ( + (1))*x1*x3 + ( + (1))*x0*x1*x3 + ( + (1))*x1*x2 + ( + (1))*x0*x1*x2;
  Id dFd0(x0?,x1?,x2?,x3?,eps?) =  + (msq) + (2*msq - s)*x1 + (3*msq)*x1*x3 + (3*msq - s)*x1*x2 + (2*msq - s)*x1^2*x3 + (msq)*x1^2*x3^2 + (2*msq - s)*x1^2*x2 + (2*msq - s)*x1^2*x2*x3 + (msq)*x1^2*x2^2 + (2*msq)*x0*x1 + (2*msq)*x0*x1^2*x3 + (2*msq)*x0*x1^2*x2;
  Id dFd1(x0?,x1?,x2?,x3?,eps?) =  + (msq) + (3*msq - s)*x3 + (msq)*x3^2 + (3*msq)*x2 + (2*msq - s)*x2*x3 + (msq)*x2^2 + (2*msq)*x1*x3 + (2*msq)*x1*x3^2 + (2*msq)*x1*x2 + (4*msq - 2*s)*x1*x2*x3 + (2*msq)*x1*x2^2 + (2*msq - s)*x0 + (3*msq)*x0*x3 + (3*msq - s)*x0*x2 + (4*msq - 2*s)*x0*x1*x3 + (2*msq)*x0*x1*x3^2 + (4*msq - 2*s)*x0*x1*x2 + (4*msq - 2*s)*x0*x1*x2*x3 + (2*msq)*x0*x1*x2^2 + (msq)*x0^2 + (2*msq)*x0^2*x1*x3 + (2*msq)*x0^2*x1*x2;
  Id dFd2(x0?,x1?,x2?,x3?,eps?) =  + (msq) + (3*msq)*x1 + (2*msq - s)*x1*x3 + (2*msq)*x1*x2 + (msq)*x1^2 + (2*msq - s)*x1^2*x3 + (2*msq)*x1^2*x2 + (3*msq - s)*x0*x1 + (2*msq - s)*x0*x1^2 + (2*msq - s)*x0*x1^2*x3 + (2*msq)*x0*x1^2*x2 + (msq)*x0^2*x1^2;
  Id ddFd2d3(x0?,x1?,x2?,x3?,eps?) =  + (2*msq - s)*x1 + (2*msq - s)*x1^2 + (2*msq - s)*x0*x1^2;
