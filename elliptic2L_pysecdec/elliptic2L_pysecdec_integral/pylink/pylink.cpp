...
#define INTEGRAL_NAME elliptic2L_pysecdec_integral
#define elliptic2L_pysecdec_integral_number_of_sectors 16
...
#define integral_has_complex_parameters 1
...
// delegate some template instantiations to separate translation units
    ...
    #define EXTERN_SIDI_QMC_SEPARATE(SIDIDEGREE) \
        ...
        extern template class secdecutil::integrators::Qmc< \
                                                               ...
                                                               ::integrators::fitfunctions::PolySingular::type \
                                                          >;
    #if elliptic2L_pysecdec_integral_number_of_sectors != 1
...
#undef elliptic2L_pysecdec_integral_number_of_sectors
