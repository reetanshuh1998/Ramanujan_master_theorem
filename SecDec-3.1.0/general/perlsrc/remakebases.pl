  ...
  #
  #  USAGE
  #  is called from polenumerics.pl, subexploop.pl, subexpgeneral.pl, finishnumericsloop.pl and finishnumericsgeneral.pl,
  #  justnumericsloop.pl and justnumericsgeneral.pl
  #
  #  USED BY 
  #  polenumerics.pl, subexploop.pl, subexpgeneral.pl, finishnumericsloop.pl and finishnumericsgeneral.pl, 
  #  justnumericsloop.pl and justnumericsgeneral.pl
  #
  #  PURPOSE
