...
symbolicsubtraction=
  Block[{initialisetemplists,tempcoeff,tempset,tempexponents,tempepspower,
    ...
    Block[{txpd,initexpo},
	  ...
	  (* The limits of the Do loop are set to feynpars instead of feynpars+1 because the 
	     Nn-1 Feynman parameters should be relabelled already at this stage *)
 ...
 initialiseab:=
    Block[{at,iabk},
	   ...
	   Do[
	      ...
	      If[at<=-1,a[iabk]=at]
	      ,
	      {iabk,feynpars}(* change to feynpars+1 ? *)
	      ];
	   ];
