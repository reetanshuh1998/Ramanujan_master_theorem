* 28.10.08 changed line 69 to suppress printing of Bases logo
***********************************************************************
*    =======================================                          *
...
c     . 8X,'**********************************************************',
c     ./8X,'*                                                        *',
c     ./8X,'*     BBBBBBB     AAAA     SSSSSS   EEEEEE   SSSSSS      *',
c     ./8X,'*     BB    BB   AA  AA   SS    SS  EE      SS    SS     *',
c     ./8X,'*     BB    BB  AA    AA  SS        EE      SS           *',
c     ./8X,'*     BBBBBBB   AAAAAAAA   SSSSSS   EEEEEE   SSSSSS      *',
c     ./8X,'*     BB    BB  AA    AA        SS  EE            SS     *',
c     ./8X,'*     BB    BB  AA    AA  SS    SS  EE      SS    SS     *',
c     ./8X,'*     BBBB BB   AA    AA   SSSSSS   EEEEEE   SSSSSS      *',
c     ./8X,'*                                                        *',
c     ./8X,'*                   BASES Version 5.1                    *',
c     ./8X,'*           coded by S.Kawabata KEK, March 1994          *',
c     ./8X,'**********************************************************')
...
C----------------------------------------------------------- BASES
  ...
  900 WRITE(LU,9950)
c 9950 FORMAT(1X,'******** FATAL ERROR IN BASES **************',
c     .      /1X,'There are not enough good points in this iteration.',
c     .      /1X,'Process was terminated due to this error.')
c
c changed 18.6.04 
 9950 FORMAT(1X,'Function seems to be zero (not enough good points)',
     .      /1X,'Has been set to zero by hand')
