#ifndef box2L_invprop_pysecdec_hpp_included
#define box2L_invprop_pysecdec_hpp_included
...
namespace box2L_invprop_pysecdec
{
    ...
    #define box2L_invprop_pysecdec_contour_deformation 1
    ...
    template<template<typename...> class container_t> using handler_t = secdecutil::amplitude::WeightedIntegralHandler<integrand_return_t,real_t,integrand_return_t,container_t>;
            ...
            typedef secdecutil::CudaIntegrandContainerWithDeformation
                    <
                        ...
                        'b','o','x','2','L','_','i','n','v','p','r','o','p','_','p','y','s','e','c','d','e','c'
                    >
                    cuda_integrand_t;
...
{
    template <>
    struct common_type<box2L_invprop_pysecdec::cuda_together_integrand_t, box2L_invprop_pysecdec::cuda_integrand_t> 
    {
        using type = box2L_invprop_pysecdec::cuda_together_integrand_t;
    };
}
#endif
