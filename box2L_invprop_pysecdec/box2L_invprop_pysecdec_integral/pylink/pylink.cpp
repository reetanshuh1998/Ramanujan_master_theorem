...
#define INTEGRAL_NAME box2L_invprop_pysecdec_integral
#define box2L_invprop_pysecdec_integral_number_of_sectors 70
...
// delegate some template instantiations to separate translation units
    ...
    #define EXTERN_SIDI_QMC_SEPARATE(SIDIDEGREE) \
        ...
        extern template class secdecutil::integrators::Qmc< \
                                                               ...
                                                               ::integrators::fitfunctions::PolySingular::type \
                                                          >;
    #if box2L_invprop_pysecdec_integral_number_of_sectors != 1
...
#undef box2L_invprop_pysecdec_integral_number_of_sectors
