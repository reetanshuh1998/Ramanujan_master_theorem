#ifndef box2L_invprop_pysecdec_integral_hpp_included
#define box2L_invprop_pysecdec_integral_hpp_included
...
namespace box2L_invprop_pysecdec_integral
{
    ...
    #define box2L_invprop_pysecdec_integral_has_complex_parameters 0

    // whether or not the return type should be complex in any case
    #define box2L_invprop_pysecdec_integral_enforce_complex_return_type 0
    ...
    #endif
    #if box2L_invprop_pysecdec_integral_has_complex_parameters || box2L_invprop_pysecdec_integral_contour_deformation || box2L_invprop_pysecdec_integral_enforce_complex_return_type
    ...
    const std::string package_name = "box2L_invprop_pysecdec_integral";

    const unsigned long long number_of_sectors = 70;
    ...
    const std::vector<std::string> names_of_real_parameters = {"s","t"};

    const unsigned int number_of_complex_parameters = 0;
    const std::vector<std::string> names_of_complex_parameters = {};

    const std::vector<int> lowest_orders = {-4}; // not including the prefactor
    ...
    //#undef box2L_invprop_pysecdec_integral_has_complex_parameters
    //#undef box2L_invprop_pysecdec_integral_enforce_complex_return_type
...
{
    template <>
    struct common_type<box2L_invprop_pysecdec_integral::cuda_together_integrand_t, box2L_invprop_pysecdec_integral::cuda_integrand_t> 
    {
        using type = box2L_invprop_pysecdec_integral::cuda_together_integrand_t;
    };
}
#endif
