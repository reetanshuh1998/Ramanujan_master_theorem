...
#procedure defineExpansion
  Global expansion = SecDecInternalsDUMMYIntegrand;
    Id SecDecInternalsDUMMYIntegrand = (( + (( + (1)) * (( + (1))^(-1)))) * ( + (((( + (1)*x0^-6*x1^-2)^( + (1))) * (( + ( + (1))*x0^-2*x1^-1)^( + (0))) * (( + ( + (1))*x0^-3*x1^-2)^( + (0) + (-2))) * (( + (1))^( + (1)))) * (SecDecInternalCalI( + (1)*x0, + (1)*x1, + (1)*x2, + (1)*x3, + (1)*x4, + (0))))));
...
#procedure insertOther
  ...
  Id SecDecInternalCondefFac(x0?,x1?,x2?,x3?,x4?,eps?) = ((SecDecInternalCondefFacx0( + (1)*x0, + (1)*x1, + (1)*x2, + (1)*x3, + (1)*x4)) ^ ( + (0))) * ((SecDecInternalCondefFacx1( + (1)*x0, + (1)*x1, + (1)*x2, + (1)*x3, + (1)*x4)) ^ ( + (2) + (1)*eps)) * ((SecDecInternalCondefFacx2( + (1)*x0, + (1)*x1, + (1)*x2, + (1)*x3, + (1)*x4)) ^ ( + (0))) * ((SecDecInternalCondefFacx3( + (1)*x0, + (1)*x1, + (1)*x2, + (1)*x3, + (1)*x4)) ^ ( + (0))) * ((SecDecInternalCondefFacx4( + (1)*x0, + (1)*x1, + (1)*x2, + (1)*x3, + (1)*x4)) ^ ( + (0)));
  Id SecDecInternalOtherPoly0(x0?,x1?,x2?,x3?,x4?,eps?) =  + ( + (1));

#endProcedure

#procedure insertDecomposed
    Id ddFd1d2(x0?,x1?,x2?,x3?,x4?,eps?) =  + (2*msq) + (2*msq - s)*x4 + (2*msq)*x1 + (4*msq - 2*s)*x1*x4 + (2*msq)*x1*x4^2 + (-s)*x0 + (-2*s)*x0*x1 + (-2*s)*x0*x1*x4;
  Id ddFd0d2(x0?,x1?,x2?,x3?,x4?,eps?) =  + (-s)*x1 + (-s)*x1^2 + (-s)*x1^2*x4;
  Id dFd3(x0?,x1?,x2?,x3?,x4?,eps?) =  + (msq) + (2*msq)*x1 + (2*msq)*x1*x4 + (msq)*x1^2 + (2*msq - s)*x1^2*x4 + (msq)*x1^2*x4^2;
  Id dFd2(x0?,x1?,x2?,x3?,x4?,eps?) =  + (msq) + (2*msq)*x1 + (2*msq - s)*x1*x4 + (msq)*x1^2 + (2*msq - s)*x1^2*x4 + (msq)*x1^2*x4^2 + (-s)*x0*x1 + (-s)*x0*x1^2 + (-s)*x0*x1^2*x4;
  Id F(x0?,x1?,x2?,x3?,x4?,eps?) =  + ( + (-s))*x0*x1^2*x2*x4 + ( + (msq))*x0*x1^2*x4^2 + ( + (msq))*x1^2*x2*x4^2 + ( + (msq))*x1^2*x3*x4^2 + ( + (-s))*x0*x1*x2 + ( + (2*msq))*x0*x1*x4 + ( + (2*msq - s))*x1*x2*x4 + ( + (2*msq))*x1*x3*x4 + ( + (msq))*x1*x4^2 + ( + (msq))*x0 + ( + (msq))*x2 + ( + (msq))*x3 + ( + (msq))*x4 + ( + (-s))*x0*x1^2*x2 + ( + (2*msq - s))*x0*x1^2*x4 + ( + (2*msq - s))*x1^2*x2*x4 + ( + (2*msq - s))*x1^2*x3*x4 + ( + (2*msq - s))*x0*x1 + ( + (2*msq))*x1*x2 + ( + (2*msq))*x1*x3 + ( + (2*msq - s))*x1*x4 + ( + (msq)) + ( + (msq))*x0*x1^2 + ( + (msq))*x1^2*x2 + ( + (msq))*x1^2*x3 + ( + (msq))*x1;
  Id ddFd3d3(x0?,x1?,x2?,x3?,x4?,eps?) =  + (0);
  Id ddFd0d4(x0?,x1?,x2?,x3?,x4?,eps?) =  + (2*msq)*x1 + (2*msq - s)*x1^2 + (2*msq)*x1^2*x4 + (-s)*x1^2*x2;
  Id ddFd0d1(x0?,x1?,x2?,x3?,x4?,eps?) =  + (2*msq - s) + (2*msq)*x4 + (-s)*x2 + (2*msq)*x1 + (4*msq - 2*s)*x1*x4 + (2*msq)*x1*x4^2 + (-2*s)*x1*x2 + (-2*s)*x1*x2*x4;
  Id ddFd2d2(x0?,x1?,x2?,x3?,x4?,eps?) =  + (0);
  Id dFd0(x0?,x1?,x2?,x3?,x4?,eps?) =  + (msq) + (2*msq - s)*x1 + (2*msq)*x1*x4 + (-s)*x1*x2 + (msq)*x1^2 + (2*msq - s)*x1^2*x4 + (msq)*x1^2*x4^2 + (-s)*x1^2*x2 + (-s)*x1^2*x2*x4;
  Id ddFd0d0(x0?,x1?,x2?,x3?,x4?,eps?) =  + (0);
  Id ddFd1d3(x0?,x1?,x2?,x3?,x4?,eps?) =  + (2*msq) + (2*msq)*x4 + (2*msq)*x1 + (4*msq - 2*s)*x1*x4 + (2*msq)*x1*x4^2;
  Id ddFd4d4(x0?,x1?,x2?,x3?,x4?,eps?) =  + (2*msq)*x1 + (2*msq)*x1^2*x3 + (2*msq)*x1^2*x2 + (2*msq)*x0*x1^2;
  Id U(x0?,x1?,x2?,x3?,x4?,eps?) =  + ( + (1)) + ( + (1))*x1*x3 + ( + (1))*x1*x2 + ( + (1))*x0*x1 + ( + (1))*x4 + ( + (1))*x3 + ( + (1))*x2 + ( + (1))*x0 + ( + (1))*x1*x3*x4 + ( + (1))*x1*x2*x4 + ( + (1))*x0*x1*x4;
  Id ddFd0d3(x0?,x1?,x2?,x3?,x4?,eps?) =  + (0);
  Id ddFd2d4(x0?,x1?,x2?,x3?,x4?,eps?) =  + (2*msq - s)*x1 + (2*msq - s)*x1^2 + (2*msq)*x1^2*x4 + (-s)*x0*x1^2;
  Id ddFd1d1(x0?,x1?,x2?,x3?,x4?,eps?) =  + (2*msq)*x3 + (4*msq - 2*s)*x3*x4 + (2*msq)*x3*x4^2 + (2*msq)*x2 + (4*msq - 2*s)*x2*x4 + (2*msq)*x2*x4^2 + (2*msq)*x0 + (4*msq - 2*s)*x0*x4 + (2*msq)*x0*x4^2 + (-2*s)*x0*x2 + (-2*s)*x0*x2*x4;
  Id ddFd3d4(x0?,x1?,x2?,x3?,x4?,eps?) =  + (2*msq)*x1 + (2*msq - s)*x1^2 + (2*msq)*x1^2*x4;
  Id dFd1(x0?,x1?,x2?,x3?,x4?,eps?) =  + (msq) + (2*msq - s)*x4 + (msq)*x4^2 + (2*msq)*x3 + (2*msq)*x3*x4 + (2*msq)*x2 + (2*msq - s)*x2*x4 + (2*msq)*x1*x3 + (4*msq - 2*s)*x1*x3*x4 + (2*msq)*x1*x3*x4^2 + (2*msq)*x1*x2 + (4*msq - 2*s)*x1*x2*x4 + (2*msq)*x1*x2*x4^2 + (2*msq - s)*x0 + (2*msq)*x0*x4 + (-s)*x0*x2 + (2*msq)*x0*x1 + (4*msq - 2*s)*x0*x1*x4 + (2*msq)*x0*x1*x4^2 + (-2*s)*x0*x1*x2 + (-2*s)*x0*x1*x2*x4;
  Id dFd4(x0?,x1?,x2?,x3?,x4?,eps?) =  + (msq) + (2*msq - s)*x1 + (2*msq)*x1*x4 + (2*msq)*x1*x3 + (2*msq - s)*x1*x2 + (2*msq - s)*x1^2*x3 + (2*msq)*x1^2*x3*x4 + (2*msq - s)*x1^2*x2 + (2*msq)*x1^2*x2*x4 + (2*msq)*x0*x1 + (2*msq - s)*x0*x1^2 + (2*msq)*x0*x1^2*x4 + (-s)*x0*x1^2*x2;
  Id ddFd2d3(x0?,x1?,x2?,x3?,x4?,eps?) =  + (0);
  Id ddFd1d4(x0?,x1?,x2?,x3?,x4?,eps?) =  + (2*msq - s) + (2*msq)*x4 + (2*msq)*x3 + (2*msq - s)*x2 + (4*msq - 2*s)*x1*x3 + (4*msq)*x1*x3*x4 + (4*msq - 2*s)*x1*x2 + (4*msq)*x1*x2*x4 + (2*msq)*x0 + (4*msq - 2*s)*x0*x1 + (4*msq)*x0*x1*x4 + (-2*s)*x0*x1*x2;
