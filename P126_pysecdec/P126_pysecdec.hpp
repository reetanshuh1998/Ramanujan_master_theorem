#ifndef P126_pysecdec_hpp_included
#define P126_pysecdec_hpp_included
...
namespace P126_pysecdec
{
    ...
    #define P126_pysecdec_contour_deformation 1
...
{
    template <>
    struct common_type<P126_pysecdec::cuda_together_integrand_t, P126_pysecdec::cuda_integrand_t> 
    {
        using type = P126_pysecdec::cuda_together_integrand_t;
    };
}
#endif
