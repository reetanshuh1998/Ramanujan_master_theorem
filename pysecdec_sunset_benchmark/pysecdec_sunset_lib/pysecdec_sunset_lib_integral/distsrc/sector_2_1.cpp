...
extern "C" int
pysecdec_sunset_lib_integral__sector_2_order_1(
...
extern "C" void
pysecdec_sunset_lib_integral__sector_2_order_1__maxdeformp(
...
)
{
    ...
    for (; index < index2; index += 4) {
        ...
        auto tmp1_5 = -x0 + 1;
        auto tmp1_6 = SecDecInternalSqr(m2);
...
extern "C" int
pysecdec_sunset_lib_integral__sector_2_order_1__fpolycheck(
    const uint64_t lattice,
    const uint64_t index1,
    const uint64_t index2,
    const uint64_t * restrict genvec,
