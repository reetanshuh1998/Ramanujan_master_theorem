...
extern "C" int
pysecdec_sunset_lib_integral__sector_5_order_1(
...
extern "C" void
pysecdec_sunset_lib_integral__sector_5_order_1__maxdeformp(
...
extern "C" int
pysecdec_sunset_lib_integral__sector_5_order_1__fpolycheck(
    const uint64_t lattice,
    const uint64_t index1,
    const uint64_t index2,
    const uint64_t * restrict genvec,
