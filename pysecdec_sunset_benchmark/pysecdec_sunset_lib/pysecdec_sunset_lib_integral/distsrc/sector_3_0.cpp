...
extern "C" int
pysecdec_sunset_lib_integral__sector_3_order_0(
...
)
{
    ...
    for (; index < index2; index += 4) {
        ...
        auto tmp2_16 = tmp1_3*__PowCall5;
        auto tmp3_6 = 2*tmp2_15 + tmp2_16;
        auto tmp2_17 = x0 + __PowCall1;
        auto tmp3_7 = tmp2_15*tmp2_17;
        auto tmp2_18 = __PowCall1*__PowCall5;
        auto tmp2_19 = x1*tmp2_18;
        auto tmp2_20 = tmp1_5*__PowCall4;
        auto tmp2_21 = tmp1_13*__PowCall5;
        auto tmp2_22 = tmp1_14*__PowCall3;
        auto tmp3_8 = tmp2_22 + tmp2_21 + tmp1_12 + tmp2_20 + tmp2_19 + tmp3_7;
        auto tmp3_9 = tmp1_10*__PowCall3;
        auto tmp3_10 = __PowCall1*__PowCall4;
        auto tmp3_11 = tmp1_1*__PowCall4;
        auto tmp3_12 = 2*tmp3_10 + tmp3_11;
        auto tmp3_13 = __PowCall3 + __PowCall4;
        auto tmp3_14 = tmp3_13*x1;
        auto tmp3_15 = tmp3_14-tmp1_9;
        auto tmp2_23 = tmp1_2*tmp2_15;
        auto tmp2_24 = tmp3_2*__PowCall5;
        auto tmp3_16 = tmp2_24 + tmp2_23 + tmp3_15;
        auto tmp3_17 = tmp1_10*__PowCall5;
        auto tmp3_18 = tmp3_17 + tmp2_15 + tmp3_15;
        auto tmp3_19 = tmp1_3*tmp3_10;
        auto tmp3_20 = x0*__PowCall5;
        auto tmp3_21 = tmp3_1*__PowCall4;
        auto tmp2_25 = tmp1_8*__PowCall3;
        auto tmp3_22 = tmp2_25-tmp1_7 + tmp3_21 + tmp3_20 + tmp2_18 + tmp3_19;
        auto tmp3_23 = tmp1_2*__PowCall5;
        auto tmp3_24 = tmp1_6*__PowCall4;
        auto tmp3_25 = -psq + tmp3_24 + __PowCall3 + tmp3_23;
        auto __RealPartCall7 = SecDecInternalRealPart(__PowCall3);
        ...
        auto tmp3_34 = __PowCall3*tmp3_33;
        ...
        auto tmp3_50 = __PowCall2*SecDecInternalLambda1;
        ...
        auto _logCall1 = SecDecInternalLog(__CondefFacx0Call2);
        auto _logCall2 = SecDecInternalLog(tmp3_34);
        auto _logCall3 = SecDecInternalLog(tmp3_33);
        auto __PowCall6 = SecDecInternalSqr(tmp3_43);
        auto __PowCall7 = SecDecInternalSqr(tmp3_54);
        auto __PowCall8 = SecDecInternalSqr(tmp3_33)*tmp3_33;
        ...
        auto tmp3_68 = __PowCall5*__PowCall6;
        auto tmp3_69 = __PowCall5 + __PowCall4-psq + __PowCall3;
        auto tmp3_70 = tmp3_43*tmp3_69;
        auto tmp3_71 = tmp3_70 + __PowCall3 + tmp3_68;
        auto tmp3_72 = tmp3_54*tmp3_71;
        auto tmp3_73 = __PowCall4*__PowCall7;
        auto tmp3_74 = __PowCall6*tmp3_73;
        auto tmp3_75 = tmp3_73 + __PowCall5;
        auto tmp3_76 = tmp3_43*tmp3_75;
        auto tmp3_77 = tmp3_72 + tmp3_76 + __PowCall3 + tmp3_74;
        auto __PowCall9 = SecDecInternalSqr(tmp3_63)*tmp3_63;
        auto __DenominatorCall5 = SecDecInternalDenominator(__PowCall8);
        auto __DenominatorCall3 = SecDecInternalDenominator(__PowCall9);
        auto tmp3_78 = tmp3_34-tmp3_9;
        auto tmp3_79 = tmp3_77-tmp3_8;
        auto tmp3_80 = _logCall1-2*_logCall2-__DenominatorCall1 + 3*_logCall3;
        auto tmp3_81 = tmp3_80*tmp3_67*__DenominatorCall4*__DenominatorCall5*tmp3_34;
        auto tmp3_82 = tmp3_66*__DenominatorCall2*__DenominatorCall3*tmp3_77*__DenominatorCall1;
        ...
        auto tmp3_84 = SecDecInternalImagPart(tmp3_79);
        SecDecInternalSignCheckContourDeformation(!(tmp3_84<=0), 2);
        auto tmp3_85 = SecDecInternalRealPart(tmp3_33);
        SecDecInternalSignCheckPositivePolynomial(!(tmp3_85>=0), 1);
        auto tmp3_86 = SecDecInternalRealPart(tmp3_63);
        SecDecInternalSignCheckPositivePolynomial(!(tmp3_86>=0), 2);
        acc = acc + w*(tmp3_83);
    }
...
extern "C" void
pysecdec_sunset_lib_integral__sector_3_order_0__maxdeformp(
...
extern "C" int
pysecdec_sunset_lib_integral__sector_3_order_0__fpolycheck(
    const uint64_t lattice,
    const uint64_t index1,
    const uint64_t index2,
    const uint64_t * restrict genvec,
