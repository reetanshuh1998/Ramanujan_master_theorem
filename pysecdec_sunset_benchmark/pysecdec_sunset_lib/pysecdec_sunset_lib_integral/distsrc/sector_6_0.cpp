...
extern "C" int
pysecdec_sunset_lib_integral__sector_6_order_0(
...
)
{
    ...
    for (; index < index2; index += 4) {
        ...
        auto tmp3_24 = tmp1_2*__PowCall4;
        auto tmp3_25 = tmp1_6*__PowCall3;
        ...
        auto tmp3_35 = __PowCall5*tmp3_34;
        ...
        auto tmp3_40 = __PowCall1*SecDecInternalLambda0;
        ...
        auto tmp3_51 = SecDecInternalLambda1*__PowCall2;
        ...
        auto _logCall1 = SecDecInternalLog(__CondefFacx1Call2);
        auto _logCall2 = SecDecInternalLog(tmp3_35);
        auto _logCall3 = SecDecInternalLog(tmp3_34);
        auto __PowCall6 = SecDecInternalSqr(tmp3_44);
        auto __PowCall7 = SecDecInternalSqr(tmp3_55);
        auto __PowCall8 = SecDecInternalSqr(tmp3_34)*tmp3_34;
        ...
        auto tmp3_69 = __PowCall3*__PowCall6;
        auto tmp3_70 = __PowCall5 + __PowCall4-psq + __PowCall3;
        auto tmp3_71 = tmp3_44*tmp3_70;
        auto tmp3_72 = tmp3_71 + tmp3_69 + __PowCall4;
        auto tmp3_73 = tmp3_55*tmp3_72;
        auto tmp3_74 = __PowCall7*tmp3_69;
        auto tmp3_75 = __PowCall4*__PowCall7;
        auto tmp3_76 = tmp3_75 + __PowCall5;
        auto tmp3_77 = tmp3_44*tmp3_76;
        auto tmp3_78 = tmp3_73 + tmp3_77 + tmp3_74 + __PowCall5;
        auto __PowCall9 = SecDecInternalSqr(tmp3_64)*tmp3_64;
        auto __DenominatorCall5 = SecDecInternalDenominator(__PowCall8);
        auto __DenominatorCall3 = SecDecInternalDenominator(__PowCall9);
        auto tmp3_79 = tmp3_35-tmp3_9;
        auto tmp3_80 = tmp3_78-tmp3_8;
        auto tmp3_81 = _logCall1-2*_logCall2-__DenominatorCall1 + 3*_logCall3;
        auto tmp3_82 = tmp3_81*tmp3_68*__DenominatorCall4*__DenominatorCall5*tmp3_35;
        auto tmp3_83 = tmp3_67*__DenominatorCall2*__DenominatorCall3*tmp3_78*__DenominatorCall1;
        auto tmp3_84 = tmp3_83 + tmp3_82;
        ...
        auto tmp3_85 = SecDecInternalImagPart(tmp3_80);
        SecDecInternalSignCheckContourDeformation(!(tmp3_85<=0), 2);
        auto tmp3_86 = SecDecInternalRealPart(tmp3_34);
        SecDecInternalSignCheckPositivePolynomial(!(tmp3_86>=0), 1);
        auto tmp3_87 = SecDecInternalRealPart(tmp3_64);
        SecDecInternalSignCheckPositivePolynomial(!(tmp3_87>=0), 2);
        acc = acc + w*(tmp3_84);
    }
...
extern "C" void
pysecdec_sunset_lib_integral__sector_6_order_0__maxdeformp(
...
)
{
    ...
    for (; index < index2; index += 4) {
        ...
        auto tmp1_3 = SecDecInternalSqr(m2);
        ...
        auto tmp3_10 = SecDecInternalSqr(m1);
...
extern "C" int
pysecdec_sunset_lib_integral__sector_6_order_0__fpolycheck(
    const uint64_t lattice,
    const uint64_t index1,
    const uint64_t index2,
    const uint64_t * restrict genvec,
...
)
{
    ...
    for (; index < index2; index += 4) {
        ...
        auto fpoly_im = SecDecInternalImagPart(tmp1_1 + __Deformedx1Call*tmp1_2 + __Deformedx0Call*tmp1_1 + __Deformedx0Call*__Deformedx1Call*tmp1_4 + __Deformedx0Call*SecDecInternalSqr(__Deformedx1Call)*tmp1_2 + SecDecInternalSqr(__Deformedx0Call)*__Deformedx1Call*tmp1_3 + SecDecInternalSqr(__Deformedx0Call)*SecDecInternalSqr(__Deformedx1Call)*tmp1_3);
