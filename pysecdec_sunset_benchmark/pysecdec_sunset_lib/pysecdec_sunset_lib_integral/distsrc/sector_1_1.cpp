...
extern "C" int
pysecdec_sunset_lib_integral__sector_1_order_1(
...
)
{
    ...
    for (; index < index2; index += 4) {
        ...
        auto tmp1_13 = x1*tmp1_8;
        auto tmp1_14 = tmp1_3 + tmp1_8;
        auto tmp1_15 = -1 + x1;
        ...
        auto tmp2_19 = __PowCall8*__PowCall10;
        ...
        auto tmp3_38 = __PowCall9*tmp3_37;
        ...
        auto tmp3_75 = tmp3_74 + __PowCall10 + tmp3_72;
        auto tmp3_76 = tmp3_58*tmp3_75;
        auto tmp3_77 = __PowCall13*tmp3_72;
        auto tmp3_78 = __PowCall10*__PowCall13;
        auto tmp3_79 = __PowCall9 + tmp3_78;
        auto tmp3_80 = tmp3_47*tmp3_79;
        auto tmp3_81 = tmp3_76 + tmp3_80 + __PowCall9 + tmp3_77;
...
extern "C" void
pysecdec_sunset_lib_integral__sector_1_order_1__maxdeformp(
...
)
{
    ...
    for (; index < index2; index += 4) {
        ...
        auto tmp1_5 = -x0 + 1;
        auto tmp1_6 = SecDecInternalSqr(m1);
        ...
        auto tmp3_10 = SecDecInternalSqr(m3);
...
extern "C" int
pysecdec_sunset_lib_integral__sector_1_order_1__fpolycheck(
    const uint64_t lattice,
    const uint64_t index1,
    const uint64_t index2,
    const uint64_t * restrict genvec,
...
)
{
    ...
    for (; index < index2; index += 4) {
        ...
        auto tmp1_3 = SecDecInternalSqr(m3);
        auto tmp1_4 = tmp1_1 + tmp1_2 + tmp1_3-psq;
        auto tmp1_5 = 2*x0;
        auto tmp1_6 = tmp1_5*tmp1_3;
        auto tmp1_7 = tmp1_2 + tmp1_6;
        auto tmp3_1 = x1*tmp1_7;
        auto tmp3_2 = tmp3_1 + tmp1_6 + tmp1_4;
        auto tmp3_3 = x1*tmp3_2;
        auto tmp3_4 = tmp1_1 + tmp3_3;
        auto tmp3_5 = tmp1_3*x0;
        auto tmp1_8 = tmp3_5 + tmp1_4;
        auto tmp3_6 = x0*tmp1_8;
        auto tmp3_7 = tmp1_2 + tmp3_5;
        auto tmp3_8 = x1*tmp3_7*tmp1_5;
        auto tmp3_9 = tmp3_8 + tmp1_2 + tmp3_6;
        auto tmp3_10 = -1 + x0;
        auto tmp3_11 = x0*SecDecInternalLambda0*tmp3_10;
        auto tmp3_12 = -1 + x1;
        auto tmp3_13 = x1*SecDecInternalLambda1*tmp3_12;
        auto __RealPartCall1 = SecDecInternalRealPart(tmp3_9);
        auto __RealPartCall2 = SecDecInternalRealPart(tmp3_4);
        auto __Deformedx0Call = x0 + i_*__RealPartCall2*tmp3_11;
        auto __Deformedx1Call = x1 + i_*__RealPartCall1*tmp3_13;
