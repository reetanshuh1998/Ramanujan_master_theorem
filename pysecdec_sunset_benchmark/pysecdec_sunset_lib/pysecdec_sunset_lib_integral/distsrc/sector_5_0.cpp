...
extern "C" int
pysecdec_sunset_lib_integral__sector_5_order_0(
...
extern "C" void
pysecdec_sunset_lib_integral__sector_5_order_0__maxdeformp(
...
extern "C" int
pysecdec_sunset_lib_integral__sector_5_order_0__fpolycheck(
    const uint64_t lattice,
    const uint64_t index1,
    const uint64_t index2,
    const uint64_t * restrict genvec,
...
)
{
    ...
    for (; index < index2; index += 4) {
        ...
        auto tmp1_2 = SecDecInternalSqr(m1);
