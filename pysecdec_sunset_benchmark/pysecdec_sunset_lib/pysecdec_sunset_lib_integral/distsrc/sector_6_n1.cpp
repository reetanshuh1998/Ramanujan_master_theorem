...
extern "C" int
pysecdec_sunset_lib_integral__sector_6_order_n1(
...
extern "C" void
pysecdec_sunset_lib_integral__sector_6_order_n1__maxdeformp(
...
extern "C" int
pysecdec_sunset_lib_integral__sector_6_order_n1__fpolycheck(
    const uint64_t lattice,
    const uint64_t index1,
    const uint64_t index2,
    const uint64_t * restrict genvec,
