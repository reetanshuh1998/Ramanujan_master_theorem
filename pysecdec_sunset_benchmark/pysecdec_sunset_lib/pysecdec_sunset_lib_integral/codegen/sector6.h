...
#procedure defineExpansion
  Global expansion = SecDecInternalsDUMMYIntegrand;
    Id SecDecInternalsDUMMYIntegrand = (( + (( + (1)) * (( + (1))^(-1)))*eps^-1) * ( + (((( + (1))^( + (1))) * (( + ( + (1)))^( + (0) + (-3))) * (( + ( + (1)))^( + (0) + (1))) * (( + (1))^( + (1)))) * ((SecDecInternalCalI( + (1)*x0, + (0), + (0))))) + (((((( + (1)) * (dSecDecInternalCalId2( + (1)*x0, + (0), + (0)))) * ( + (1))))) * ( + (1)))*eps + ((((( + (0)) * (dSecDecInternalCalId2( + (1)*x0, + (0), + (0)))) * ( + (0))) + ((( + (1)) * (((( + (1)) * (ddSecDecInternalCalId2d2( + (1)*x0, + (0), + (0)))) * ( + (1))))) * ( + (1)))) * ( + (1/2)))*eps^2)) + (( + (( + (1)) * (( + (1))^(-1)))) * ( + (((( + (1)*x1)^( + (1))) * (( + ( + (1))*x1)^( + (0) + (-3))) * (( + ( + (1))*x1)^( + (0) + (1))) * (( + (1))^( + (1)))) * ((SecDecInternalCalI( + (1)*x0, + (1)*x1, + (0))) + (( + (-1)) * (SecDecInternalCalI( + (1)*x0, + (0), + (0)))))) + ((((( + (0)) * (( + (1)*x1)^( + (-3) + (0))) * (( + (1)*x1)^( + (1) + (0))) * ((SecDecInternalCalI( + (1)*x0, + (1)*x1, + (0))) + (( + (-1)) * (SecDecInternalCalI( + (1)*x0, + (0), + (0)))))) * ( + (0))) + ((( + (1)*x1) * ((( + (1)*x1)^( + (-3) + (0))) * ( + (3)) * (log( + (1)*x1))) * (( + (1)*x1)^( + (1) + (0))) * ((SecDecInternalCalI( + (1)*x0, + (1)*x1, + (0))) + (( + (-1)) * (SecDecInternalCalI( + (1)*x0, + (0), + (0)))))) * ( + (1))) + ((( + (1)*x1) * (( + (1)*x1)^( + (-3) + (0))) * ((( + (1)*x1)^( + (1) + (0))) * ( + (-2)) * (log( + (1)*x1))) * ((SecDecInternalCalI( + (1)*x0, + (1)*x1, + (0))) + (( + (-1)) * (SecDecInternalCalI( + (1)*x0, + (0), + (0)))))) * ( + (1))) + ((( + (1)*x1) * (( + (1)*x1)^( + (-3) + (0))) * (( + (1)*x1)^( + (1) + (0))) * ((((( + (1)) * (dSecDecInternalCalId2( + (1)*x0, + (1)*x1, + (0)))) * ( + (1)))) + (((( + (-1)) * (((( + (1)) * (dSecDecInternalCalId2( + (1)*x0, + (0), + (0)))) * ( + (1))))) * ( + (1)))))) * ( + (1)))) * ( + (1)))*eps));
...
#procedure insertDecomposed
    Id ddFd0d0(x0?,x1?,eps?) =  + (2*m1^2)*x1 + (2*m1^2)*x1^2;
  Id F(x0?,x1?,eps?) =  + ( + (m3^2)) + ( + (m2^2))*x1 + ( + (m3^2))*x0 + ( + (m1^2 + m2^2 + m3^2 - psq))*x0*x1 + ( + (m2^2))*x0*x1^2 + ( + (m1^2))*x0^2*x1 + ( + (m1^2))*x0^2*x1^2;
  Id ddFd1d1(x0?,x1?,eps?) =  + (2*m2^2)*x0 + (2*m1^2)*x0^2;
  Id dFd0(x0?,x1?,eps?) =  + (m3^2) + (m1^2 + m2^2 + m3^2 - psq)*x1 + (m2^2)*x1^2 + (2*m1^2)*x0*x1 + (2*m1^2)*x0*x1^2;
  Id U(x0?,x1?,eps?) =  + ( + (1))*x0*x1 + ( + (1))*x0 + ( + (1));
  Id dFd1(x0?,x1?,eps?) =  + (m2^2) + (m1^2 + m2^2 + m3^2 - psq)*x0 + (2*m2^2)*x0*x1 + (m1^2)*x0^2 + (2*m1^2)*x0^2*x1;
  Id ddFd0d1(x0?,x1?,eps?) =  + (m1^2 + m2^2 + m3^2 - psq) + (2*m2^2)*x1 + (2*m1^2)*x0 + (4*m1^2)*x0*x1;
