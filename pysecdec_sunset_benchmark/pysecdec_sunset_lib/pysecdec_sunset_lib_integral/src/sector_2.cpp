...
{
return {-1,1,{{2,{-1},1,sector_2_order_n1_integrand,
#ifdef SECDEC_WITH_CUDA
get_device_sector_2_order_n1_integrand,
#endif
sector_2_order_n1_contour_deformation_polynomial,sector_2_order_n1_maximal_allowed_deformation_parameters},{2,{0},2,sector_2_order_0_integrand,
#ifdef SECDEC_WITH_CUDA
