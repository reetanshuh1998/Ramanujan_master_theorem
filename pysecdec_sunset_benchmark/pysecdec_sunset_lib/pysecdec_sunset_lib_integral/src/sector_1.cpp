...
{
return {-1,1,{{1,{-1},1,sector_1_order_n1_integrand,
#ifdef SECDEC_WITH_CUDA
get_device_sector_1_order_n1_integrand,
#endif
sector_1_order_n1_contour_deformation_polynomial,sector_1_order_n1_maximal_allowed_deformation_parameters},{1,{0},2,sector_1_order_0_integrand,
#ifdef SECDEC_WITH_CUDA
