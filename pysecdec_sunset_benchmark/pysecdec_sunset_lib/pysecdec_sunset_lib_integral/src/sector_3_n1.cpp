...
__host__ __device__
#endif
integrand_return_t sector_3_order_n1_integrand
(
...
{
    const auto x1 = integration_variables[0]; (void)x1;
    ...
    const auto SecDecInternalLambda1 = deformation_parameters[0]; (void)SecDecInternalLambda1;
    auto tmp1_1 = -x1*psq;
    auto tmp1_2 = x1 + 1;
...
#ifdef SECDEC_WITH_CUDA
__device__ secdecutil::SectorContainerWithDeformation<real_t, complex_t>::DeformedIntegrandFunction* const device_sector_3_order_n1_integrand = sector_3_order_n1_integrand;
secdecutil::SectorContainerWithDeformation<real_t, complex_t>::DeformedIntegrandFunction* get_device_sector_3_order_n1_integrand()
{
    using IntegrandFunction = secdecutil::SectorContainerWithDeformation<real_t, complex_t>::DeformedIntegrandFunction;
    IntegrandFunction* device_address_on_host;
    auto errcode = cudaMemcpyFromSymbol(&device_address_on_host,device_sector_3_order_n1_integrand, sizeof(IntegrandFunction*));
