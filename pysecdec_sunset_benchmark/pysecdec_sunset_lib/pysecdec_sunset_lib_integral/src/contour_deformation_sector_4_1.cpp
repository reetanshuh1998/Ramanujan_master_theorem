...
#endif
integrand_return_t sector_4_order_1_contour_deformation_polynomial
(
...
)
{
    ...
    return(tmp1_1 + __Deformedx1Call*tmp1_1 + __Deformedx0Call*tmp1_2 + __Deformedx0Call*__Deformedx1Call*tmp1_4 + __Deformedx0Call*SecDecInternalSqr(__Deformedx1Call)*tmp1_3 + SecDecInternalSqr(__Deformedx0Call)*__Deformedx1Call*tmp1_2 + SecDecInternalSqr(__Deformedx0Call)*SecDecInternalSqr(__Deformedx1Call)*tmp1_3);
}
}
