...
#define INTEGRAL_NAME pysecdec_sunset_lib_integral
#define pysecdec_sunset_lib_integral_number_of_sectors 6
...
// delegate some template instantiations to separate translation units
    ...
    #define EXTERN_SIDI_QMC_SEPARATE(SIDIDEGREE) \
        ...
        extern template class secdecutil::integrators::Qmc< \
                                                               ...
                                                               ::integrators::fitfunctions::PolySingular::type \
                                                          >;
    #if pysecdec_sunset_lib_integral_number_of_sectors != 1
...
#undef pysecdec_sunset_lib_integral_number_of_sectors
